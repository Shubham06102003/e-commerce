...
const HowItWorks = () => {
  return (
    <div className="w-full min-h-screen p-10 mt-[-99px]">
      <h1 className="text-black text-4xl font-bold mb-8 text-center">How It Works</h1>
      <div className="space-y-16 max-w-4xl mx-auto">
        
        <section className="space-y-6">
          <h2 className="text-2xl font-bold text-blue-700">Step 1: Browse Products</h2>
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-bold text-blue-700">Step 2: Add to Cart</h2>
          <p className="text-gray-700 text-lg leading-relaxed">
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-bold text-blue-700">Step 3: Secure Checkout</h2>
          <p className="text-gray-700 text-lg leading-relaxed">
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-bold text-blue-700">Step 4: Shipping & Delivery</h2>
          <p className="text-gray-700 text-lg leading-relaxed">
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-bold text-blue-700">Step 5: Return & Refund</h2>
          <p className="text-gray-700 text-lg leading-relaxed">
        ...
        <section className="space-y-6">
          <h2 className="text-2xl font-bold text-blue-700">Why Shop With Us?</h2>
          <p className="text-gray-700 text-lg leading-relaxed">
        ...
        {/* FAQs Section */}
        <section className="space-y-6">
          <h2 className="text-2xl font-bold text-blue-700">Frequently Asked Questions (FAQs)</h2>

          <div className="space-y-4">
            <div className="text-lg font-semibold text-gray-800">Q: How do I track my order?</div>
            <p className="text-gray-700 text-lg leading-relaxed">
          ...
          <div className="space-y-4">
            <div className="text-lg font-semibold text-gray-800">Q: Can I modify or cancel my order after placing it?</div>
            <p className="text-gray-700 text-lg leading-relaxed">
          ...
          <div className="space-y-4">
            <div className="text-lg font-semibold text-gray-800">Q: Do you offer international shipping?</div>
            <p className="text-gray-700 text-lg leading-relaxed">
          ...
          <div className="space-y-4">
            <div className="text-lg font-semibold text-gray-800">Q: What should I do if I receive a damaged product?</div>
            <p className="text-gray-700 text-lg leading-relaxed">
          ...
          <div className="space-y-4">
            <div className="text-lg font-semibold text-gray-800">Q: How can I contact customer support?</div>
            <p className="text-gray-700 text-lg leading-relaxed">
